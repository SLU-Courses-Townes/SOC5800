...
prop.table(as.numeric(dataClean$gender), margin = NULL)
...
prop.table(as.numeric(dataClean$ethnicityRace), margin = NULL)
...
prop.table(as.numeric(dataClean$religiousAffiliation), margin = NULL)
...
prop.table(as.numeric(dataClean$educationLevels), margin = NULL)

print("whenHighestEd; 1 - before, 2 - during, 3 - after")
table(as.numeric(dataClean$whenHighestEd))
prop.table(as.numeric(dataClean$whenHighestEd), margin = NULL)

print("typeHometown; 1 - rural, 2 - suburban, 3 - urban")
table(as.numeric(dataClean$typeHometown))
prop.table(as.numeric(dataClean$typeHometown), mmargin = NULL)
