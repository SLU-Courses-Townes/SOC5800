...
print("selfEmployement")
table(dataClean$selfEmployment)
```
...
```{r means}
# Comparison of grit for cases grouped by financialStatus
groups <- group_by(dataClean, financialStatus)
aovGroup <- aov(as.numeric(financialStatus) ~ gritScore, data = groups)
summary(aovGroup)
```
